...
class LoginForm(forms.Form):
    ...
    username = forms.CharField(**form_kwargs(widget=forms.TextInput(
        attrs=widget_attrs("Username"))))
    password = forms.CharField(**form_kwargs(widget=forms.PasswordInput(
...
class RegistrationForm(forms.Form):
    ...
    email = forms.EmailField(**form_kwargs(widget=forms.TextInput(
        attrs=widget_attrs("Email"))))

    password = forms.CharField(**form_kwargs(widget=forms.PasswordInput(
        attrs=widget_attrs("Password"))))

    password_confirmation = forms.CharField(**form_kwargs(
